...
sword_list_1 = [sword_0, sword_1, sword_2, sword_3, sword_4, sword_5]
sword_list_2 = [sword_6, sword_7, sword_8, sword_9, sword_10, sword_11, \
                sword_12, sword_13, sword_14, sword_15, sword_16, sword_17, \
                sword_18]
sword_list_3 = [sword_19, sword_20, sword_21, sword_22, sword_23, sword_24, \
...
def main():
    ...
    player_1 = player([], 1000000, 0, [])
    player_1.sword.append(sword_0)

    while True:
        print(f"{player_1.sword.name}\n강화 성공률 : {player_1.sword.success_rate}%\n깅화비용 : {player_1.sword.reinforcement_cost}  판매가격 : {player_1.sword.selling_price}")
